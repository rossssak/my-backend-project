...
try {
    if (!fs.existsSync(caPath)) {
        // If the file doesn't exist, create it with a default CA certificate
        // Note: In production, you should use the actual TiDB CA certificate
    ...
    // Create a fallback certificate for development
    fs.writeFileSync(caPath, '-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----');
    caContent = fs.readFileSync(caPath);
}
